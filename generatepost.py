...
def process_pending_tasks(platforms=None, dry_run=False):
        ...
        with sync_playwright() as p:
            ...
            for index, row in pending_df.iterrows():
                ...
                try:
                    ...
                    result = run_gemini_task(page, prompt, task_type, run_dir, platforms)
    ...
    print("SUMMARY")
    print("=" * 80)
    print(f"Tasks processed: {len(pending_df)}")
...
Examples:
  ...
  python generate_and_post_from_excel.py --dry-run
    ...
    success = process_pending_tasks(platforms=args.platforms, dry_run=args.dry_run)
